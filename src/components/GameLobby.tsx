...
const GameLobby = ({ onShowRules }: GameLobbyProps) => {
  ...
  if (showGame) {
    return <GameSimulator onExit={() => setShowGame(false)} gameMode={gameMode} difficulty={difficulty} />;
  }
  ...
  return (
    <div className="space-y-6">
        ...
        <Card className="bg-white/20 backdrop-blur-sm border-white/20">
          <CardContent className="p-6">
            ...
            <div className="space-y-4">
              ...
              {gameMode !== "solo" && (
                <div className="space-y-2">
                  <Label htmlFor="players" className="text-white">Joueurs connectés</Label>
                  <div className="bg-white/30 border border-white/20 rounded-md p-3">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center">
                        <Users className="h-4 w-4 mr-2 text-white" />
                        <span className="text-sm text-white">Salon principal</span>
                      </div>
      ...
      <div className="flex justify-center pt-4">
        ...
        >
          {gameMode === "solo" ? "Commencer la partie" : "Rejoindre la partie"}
        </Button>
      </div>
